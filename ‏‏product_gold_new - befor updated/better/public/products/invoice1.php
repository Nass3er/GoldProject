...
<body>
    ...
    <br>
    <div class="all">
    <?php  include_once "../../views/tableInvoice.php" ?>  
                  
    </div>
                                   <?php //require_once "../../getIsSelect.php" ?>
                                   <?php  //include_once "../../views/tableInvoice.php" ?> 
        ...
        let indeex= 0;
         ...
         for (let i = 1; i < tbl.rows.length-1; i++) {
              ...
              tbl.rows[i].addEventListener("click",function(){
                ...
                document.getElementById("ww").value=this.cells[2].innerHTML;
                document.getElementById("pp").value=this.cells[3].innerHTML;
                document.getElementById("dd").value=this.cells[4].innerHTML;
                document.getElementById("qq").value=this.cells[5].innerHTML;
                document.getElementById("tt").value=this.cells[6].innerHTML;
           ...
           btnch.onclick=function(){
               ...
               if (index !=0) {
                ...
                tbl.rows[index].cells[2].innerHTML= document.getElementById("ww").value;
                tbl.rows[index].cells[3].innerHTML= document.getElementById("pp").value;
                tbl.rows[index].cells[4].innerHTML=  document.getElementById("dd").value;
                tbl.rows[index].cells[5].innerHTML=  document.getElementById("qq").value;
                tbl.rows[index].cells[6].innerHTML=  document.getElementById("tt").value;
