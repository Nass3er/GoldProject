...
<div class="container">
    ...
    <div class="head">
     ...
     <a href="salesbills.php">المبيعات</a>
     <a href="product_supplier.php">موردين المنتجات</a>
     ...
     <a onclick="document.getElementById('id04').style.display='block'"
      ...
      <a onclick="document.getElementById('id0Supplier').style.display='block'"
          style="width:auto;">إضافة مورد جديد </a>
    ...
    <div id="id01" class="modal"> 
     ...
     <div id="id0Supplier" class="modal6"> 
                      
                      <form action="createSupplier.php" method="post" class="modal-content animate">
  
                           <div class="imgcont">
  
                             <span onclick="document.getElementById('id0Supplier').style.display='none'"
                             class="close2" title="close modal">&times; </span>
                           ...
                           <div class="containerPrice">
                             ...
                             <label ><b> رقم تلفون المورد</b></label>
                             <input type="text" name="phone" >
  
                             <label ><b> عنوان المورد</b></label>
                             <input type="text" name="address" >

                             <label ><b> ايميل المورد</b></label>
                  ...
                  <script>
                     ...
                     var modalSupp=document.getElementById('id0Supplier');
                     window.onclick=function(event){
    ...
    <!-- end head div -->
        ...
        <div class="my">
             <div class="showAsTable">
                    <a href="index.php" class="visit" id="list"> قائمة</a>  
                  <a href="indexAsTable.php" class="visit" id="tab">جدول</a> 
                  <button type="button" class="btn-notification">
                     <span class="img-icon-notif"><a href="invoice1.php"><img src="cart.png" alt="" height="100%" width="100%">  </a></span>
            ...
            <form action=""> 
                    <div class="search" id="hiddenSearch">
                    
                        <input type="text" class="inputSearch" placeholder="ابحث عن منتج" name="search" value="<?php echo $search?>" >
    ...
    let toggler=document.querySelector(".firstIcon");
     ...
     let wingate=document.getElementById("navigate");
     window.addEventListener("click",function(event){
                        if(event.target !=wingate && event.target !=toggler){
